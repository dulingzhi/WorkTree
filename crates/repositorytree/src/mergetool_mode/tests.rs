...
fn make_config(
    ...
    MergetoolConfig {
        ...
        label_local: None,
        label_remote: None,
        conflict_style: repositorytree_core::merge::ConflictStyle::default(),
        diff_algorithm: repositorytree_core::merge::DiffAlgorithm::default(),
        marker_size: repositorytree_core::merge::DEFAULT_MARKER_SIZE,
        auto: false,
        gui: false,
    }
}
...
fn diff3_style_includes_base_section() {
    ...
    config.conflict_style = repositorytree_core::merge::ConflictStyle::Diff3;
...
fn zdiff3_style_extracts_common_prefix_suffix() {
    ...
    config.conflict_style = repositorytree_core::merge::ConflictStyle::Zdiff3;
...
fn histogram_algorithm_produces_clean_merge_on_structural_code() {
    ...
    config.diff_algorithm = repositorytree_core::merge::DiffAlgorithm::Histogram;
