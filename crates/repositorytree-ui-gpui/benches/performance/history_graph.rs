...
pub(crate) fn bench_history_graph(c: &mut Criterion) {
    ...
    let merge_stride = env_usize("REPOSITORYTREE_BENCH_HISTORY_MERGE_EVERY", 50);
    let branch_head_every = env_usize("REPOSITORYTREE_BENCH_HISTORY_BRANCH_HEAD_EVERY", 11);
