...
pub(crate) fn bench_merge_open_bootstrap(c: &mut Criterion) {
    let small_lines = env_usize("REPOSITORYTREE_BENCH_MERGE_BOOTSTRAP_SMALL_LINES", 5_000);
    ...
    let lines = env_usize("REPOSITORYTREE_BENCH_MERGE_BOOTSTRAP_LINES", 55_001);
    let conflict_blocks = env_usize("REPOSITORYTREE_BENCH_MERGE_BOOTSTRAP_CONFLICTS", 1);
    ...
    let many_conflicts_blocks = env_usize("REPOSITORYTREE_BENCH_MERGE_BOOTSTRAP_MANY_CONFLICTS", 50);
    ...
    let extreme_lines = env_usize("REPOSITORYTREE_BENCH_MERGE_BOOTSTRAP_EXTREME_LINES", 50_000);
    let extreme_conflicts = env_usize("REPOSITORYTREE_BENCH_MERGE_BOOTSTRAP_EXTREME_CONFLICTS", 500);
    let large_many =
