...
pub(crate) use repositorytree_core::file_diff::BenchmarkReplacementDistanceBackend;
pub(crate) use repositorytree_ui_gpui::benchmarks::{
...
use repositorytree_ui_gpui::perf_alloc::{
...
pub(crate) const SUPPRESS_MISSING_REAL_REPO_NOTICE_ENV: &str =
    "REPOSITORYTREE_PERF_SUPPRESS_MISSING_REAL_REPO_NOTICE";
...
pub(crate) fn markdown_preview_measurement_time() -> Duration {
    Duration::from_millis(
        env_usize("REPOSITORYTREE_BENCH_MARKDOWN_PREVIEW_MEASUREMENT_MS", 250).max(250) as u64,
    )
}
