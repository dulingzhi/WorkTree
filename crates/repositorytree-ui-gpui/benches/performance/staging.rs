...
pub(crate) fn bench_staging(c: &mut Criterion) {
    let stage_files = env_usize("REPOSITORYTREE_BENCH_STAGING_FILES", 10_000);
    let interleaved_files = env_usize("REPOSITORYTREE_BENCH_STAGING_INTERLEAVED_FILES", 1_000);
