...
pub(crate) fn strict_from_env() -> bool {
    match env::var("REPOSITORYTREE_PERF_BUDGET_STRICT") {
...
pub(crate) fn usage() -> &'static str {
    "Usage: cargo run -p repositorytree-ui-gpui --bin perf_budget_report -- [--criterion-root PATH]... [--strict] [--skip-missing] [--fresh-reference PATH]"
}
