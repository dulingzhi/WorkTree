...
mod harness {
    use repositorytree_ui_gpui::benchmarks::{
        IdleResourceConfig, IdleResourceFixture, IdleResourceMetrics, IdleResourceScenario,
    };
    use repositorytree_ui_gpui::perf_alloc::{TRACKING_MIMALLOC, measure_allocations};
    use repositorytree_ui_gpui::perf_ram_guard::install_benchmark_process_ram_guard;
    ...
    const CPU_WINDOW_MS_ENV: &str = "REPOSITORYTREE_PERF_IDLE_CPU_WINDOW_MS";
    const MEMORY_WINDOW_MS_ENV: &str = "REPOSITORYTREE_PERF_IDLE_MEMORY_WINDOW_MS";
    const SAMPLE_INTERVAL_MS_ENV: &str = "REPOSITORYTREE_PERF_IDLE_SAMPLE_INTERVAL_MS";
    const REFRESH_CYCLES_ENV: &str = "REPOSITORYTREE_PERF_IDLE_REFRESH_CYCLES";
    const WAKE_GAP_MS_ENV: &str = "REPOSITORYTREE_PERF_IDLE_WAKE_GAP_MS";
    const TRACKED_FILES_ENV: &str = "REPOSITORYTREE_PERF_IDLE_TRACKED_FILES_PER_REPO";
    ...
    fn emit_idle_sidecar(
        ...
        alloc_metrics: repositorytree_ui_gpui::perf_alloc::PerfAllocMetrics,
