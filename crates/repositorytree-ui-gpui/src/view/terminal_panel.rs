...
impl TerminalViewportView {
    ...
    /// [`RepositoryTreeView::forward_keystroke_to_focused_terminal`].
    fn handle_key_down(
        &mut self,
...
// ============================================================================
// RepositoryTreeView terminal methods
// ============================================================================
...
impl RepositoryTreeView {
    ...
    /// interceptor (see [`RepositoryTreeView::install_terminal_keystroke_interceptor`]),
    ...
    fn render_terminal_header(
        ...
        let icon_btn = move |id: &'static str, icon: &'static str, tip: &'static str| {
            div()
                ...
                .repositorytree_tooltip(theme, tip.into())
        };
        ...
        for (i, title) in tabs.iter().enumerate() {
            ...
            let tab = div()
                ...
                .child(title.clone())
                .child(close)
                .repositorytree_tooltip(theme, title.clone())
                .on_mouse_down(
                    MouseButton::Left,
                    cx.listener(move |this, _e: &MouseDownEvent, window, cx| {
        ...
        let new_tab = div()
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("chrome.terminal.new_tab"))
            .on_mouse_down(
                MouseButton::Left,
                cx.listener(move |this, _e: &MouseDownEvent, window, cx| {
...
// ============================================================================
// RustDrop for RepositoryTreeView
// ============================================================================

impl Drop for RepositoryTreeView {
    fn drop(&mut self) {
...
fn terminate_terminals_for_action(view: &mut RepositoryTreeView, action: &TerminalShutdownAction) {
    match action {
        TerminalShutdownAction::CloseRepo { repo_id }
        | TerminalShutdownAction::CloseTerminalForRepo { repo_id } => {
...
mod tests {
    ...
    fn friendly_terminal_title_collapses_shell_paths_to_the_program_stem() {
        ...
        assert_eq!(
            friendly_terminal_title("PS C:\\Users\\sampo\\git\\RepositoryTree".to_string()),
            "PS C:\\Users\\sampo\\git\\RepositoryTree"
        );
