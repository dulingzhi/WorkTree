...
struct ConflictSplitPageCache {
    pages: FxHashMap<usize, Arc<[repositorytree_core::file_diff::FileDiffRow]>>,
...
impl ConflictSplitPageCache {
    ...
    fn get(&mut self, page_ix: usize) -> Option<Arc<[repositorytree_core::file_diff::FileDiffRow]>> {
    ...
    fn insert(
        &mut self,
        page_ix: usize,
        page: Arc<[repositorytree_core::file_diff::FileDiffRow]>,
    ) -> Arc<[repositorytree_core::file_diff::FileDiffRow]> {
...
impl ConflictSplitRowIndex {
    ...
    fn build_page(
        ...
        page_ix: usize,
    ) -> Option<Arc<[repositorytree_core::file_diff::FileDiffRow]>> {
                    ...
                    for offset in 0..row_count {
                        ...
                        let kind = match (old_text, new_text) {
                            (Some(old), Some(new)) if old == new => {
                                repositorytree_core::file_diff::FileDiffRowKind::Context
                            }
                            (Some(_), Some(_)) => repositorytree_core::file_diff::FileDiffRowKind::Modify,
                            (Some(_), None) => repositorytree_core::file_diff::FileDiffRowKind::Remove,
                            (None, Some(_)) => repositorytree_core::file_diff::FileDiffRowKind::Add,
                            (None, None) => continue,
                        };
    ...
    pub(in crate::view) fn for_each_row_range(
        ...
        mut f: impl FnMut(usize, &repositorytree_core::file_diff::FileDiffRow),
    ) {
...
fn conflict_text_line_text(
    ...
    match &text.storage {
        ...
        ConflictTextStorage::SharedSlice { text, range: base } => {
            ...
            Some(repositorytree_core::file_diff::FileDiffLineText::shared_slice(
                Arc::clone(text),
                start..end,
            ))
        }
...
pub struct TwoWaySplitVisibleRow {
    ...
    pub row: repositorytree_core::file_diff::FileDiffRow,
    pub conflict_ix: Option<usize>,
}
