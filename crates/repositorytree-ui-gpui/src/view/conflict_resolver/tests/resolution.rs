...
fn apply_session_region_resolutions_applies_pick_states() {
    use repositorytree_core::conflict_session::{ConflictRegion, ConflictRegionResolution as R};
...
fn autosolve_trace_summary_history_mode_uses_history_stat() {
    let stats = repositorytree_state::msg::ConflictAutosolveStats {
        pass1: 0,
        pass2_split: 0,
        pass1_after_split: 0,
        regex: 0,
...
fn auto_resolve_regex_equivalent_sides() {
    use repositorytree_core::conflict_session::RegexAutosolveOptions;
