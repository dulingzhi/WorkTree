...
fn history_scope_shows_graph_color_marker(scope: repositorytree_core::domain::LogScope) -> bool {
    !matches!(scope, repositorytree_core::domain::LogScope::FirstParent)
}
...
fn worktree_uncommitted_history_row(
    ...
    .repositorytree_tooltip(theme, badge_tooltip)
...
mod tests {
    ...
    fn image_paths_resolve_only_inside_the_documents_own_directory() {
        let dir = std::env::temp_dir().join(format!(
            "repositorytree_md_image_path_{}_{}",
            std::process::id(),
    ...
    fn markdown_preview_code_rows_reuse_diff_syntax_highlighting() {
        ...
        let light = markdown_preview_row_styled_text(AppTheme::repositorytree_light(), &row);
