            ...
            .map(|(ix, row)| match row {
                BranchSidebarRow::PinnedHeader {
                    ...
                    div()
                        ...
                        .repositorytree_tooltip(theme, label)
                ...
                BranchSidebarRow::SectionHeader {
                    ...
                    div()
                        ...
                        .repositorytree_tooltip(theme, tooltip.clone())
                        .on_click(cx.listener(move |this, e: &ClickEvent, _w, cx| {
                            if !e.standard_click() || e.click_count() != 1 {
                                return;
                            }
                ...
                BranchSidebarRow::Branch {
                    ...
                    if show_workspace_badge {
                        ...
                        let worktree_badge = div()
                            ...
                            .repositorytree_tooltip(theme, worktree_badge_tooltip.clone());
...
impl DetailsPaneView {
    ...
    pub(in super::super) fn render_worktree_file_rows(
        ...
        let origin = repositorytree_state::model::ForeignDiffOrigin::Worktree {
...
mod tests {
    ...
    fn sync_view_for_tests(cx: &mut gpui::VisualTestContext, view: &gpui::Entity<RepositoryTreeView>) {
        cx.update(|window, app| {
    ...
    fn active_log_seq(store: &AppStore, repo_id: RepoId) -> repositorytree_state::model::LogLoadSeq {
        store
            .snapshot()
            .repos
            .iter()
    ...
    fn worktree_badge_colors_follow_open_and_menu_state() {
        let palette = worktree_badge_palette(AppTheme::repositorytree_dark());
    ...
    fn worktree_origin_label_pairs_branch_with_folder() {
        assert_eq!(
            worktree_origin_label(Some("dev"), false, std::path::Path::new("/home/u/RepositoryTree")),
            "dev · RepositoryTree"
        );
    }
    ...
    fn worktree_origin_label_names_a_detached_worktree_by_its_folder() {
        assert_eq!(
            worktree_origin_label(None, true, std::path::Path::new("/home/u/RepositoryTree2")),
            "(detached) · RepositoryTree2"
        );
    }
    ...
    fn worktree_origin_label_falls_back_when_one_half_is_missing() {
        ...
        assert_eq!(
            worktree_origin_label(None, false, std::path::Path::new("/home/u/RepositoryTree3")),
            "RepositoryTree3"
        );
