...
impl MainPaneView {
    ...
    fn conflict_context_fold_row(
        ...
        div()
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("misc.conflict_fold.expand_all"))
            .into_any_element()
    }
                    ...
                    .child({
                        ...
                        div()
                            ...
                            .when_some(confidence, |d, confidence| {
                                use repositorytree_core::conflict_session::AutosolveConfidence;
...
fn split_cell_bg(
    theme: AppTheme,
    kind: repositorytree_core::file_diff::FileDiffRowKind,
    side: ConflictPickSide,
) -> gpui::Rgba {
    ...
    match (kind, side) {
        (repositorytree_core::file_diff::FileDiffRowKind::Add, ConflictPickSide::Theirs)
        | (repositorytree_core::file_diff::FileDiffRowKind::Modify, ConflictPickSide::Theirs) => {
            with_alpha(
                theme.colors.accent.foreground,
                if theme.is_dark { 0.14 } else { 0.10 },
            )
        }
        (repositorytree_core::file_diff::FileDiffRowKind::Remove, ConflictPickSide::Ours)
        | (repositorytree_core::file_diff::FileDiffRowKind::Modify, ConflictPickSide::Ours) => {
            with_alpha(
                theme.colors.status.success.foreground,
                if theme.is_dark { 0.10 } else { 0.08 },
            )
