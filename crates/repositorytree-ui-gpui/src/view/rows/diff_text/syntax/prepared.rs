...
fn syntax_cache_drop_sender() -> Option<&'static mpsc::Sender<SyntaxCacheDropMessage>> {
    ...
    SENDER
        .get_or_init(|| {
            ...
            let builder = std::thread::Builder::new().name("repositorytree-syntax-drop".to_string());
            let _handle = builder
                .spawn(move || {
...
fn syntax_chunk_worker() -> Option<&'static PreparedSyntaxChunkWorker> {
    ...
    WORKER
        .get_or_init(|| {
            ...
            let builder = std::thread::Builder::new().name("repositorytree-syntax-chunks".to_string());
            let _handle = builder
                .spawn(move || {
