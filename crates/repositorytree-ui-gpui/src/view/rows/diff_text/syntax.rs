...
const TS_INCREMENTAL_REPARSE_ENABLE_ENV: &str = "REPOSITORYTREE_DIFF_SYNTAX_INCREMENTAL_REPARSE";
...
mod tests {
    ...
    impl TempFileBackedLineFixture {
        fn new(name: &str, text: &str) -> Self {
            ...
            let raw_text = repositorytree_core::file_diff::FileDiffLineText::file_slice(
                Arc::new(path.clone()),
                0..text.len(),
                false,
                false,
    ...
    fn streamed_ascii_json_slice_keeps_string_state_after_checkpoint() {
        ...
        let raw_text = repositorytree_core::file_diff::FileDiffLineText::shared(Arc::from(text));
    ...
    fn streamed_slices_resume_inside_batch_line_comments() {
        ...
        for (language, opener) in [
            ...
            let raw_text =
                repositorytree_core::file_diff::FileDiffLineText::shared(Arc::from(text.clone()));
