...
use repositorytree_core::domain::{DiffArea, DiffLineKind};
use gpui::{
...
pub(in crate::view) struct RowBlamePaint {
    ...
    pub(in crate::view) commit_id: repositorytree_core::domain::CommitId,
    ...
    pub(in crate::view) prior_commit: Option<repositorytree_core::domain::CommitId>,
...
/// suppressed.
fn blame_commit_is_navigable(commit_id: &repositorytree_core::domain::CommitId) -> bool {
...
fn install_blame_annotation_mouse_handler(
    ...
    prior_commit: Option<repositorytree_core::domain::CommitId>,
...
pub(super) struct StreamedDiffTextPaintSpec {
    pub(super) raw_text: repositorytree_core::file_diff::FileDiffLineText,
...
mod tests {
    ...
    fn streamed_query_spec(
        ...
        StreamedDiffTextPaintSpec {
            raw_text: repositorytree_core::file_diff::FileDiffLineText::from(raw_text),
