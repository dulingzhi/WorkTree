...
fn status_row(
    ...
    let stage_button = components::Button::new(format!("stage_btn_{ix}"), stage_label)
        ...
        .repositorytree_tooltip(theme, stage_tooltip.clone());
...
mod tests {
    ...
    fn commit_id(id: &str) -> repositorytree_core::domain::CommitId {
        repositorytree_core::domain::CommitId(Arc::from(id))
    }
    ...
    fn submodule_status_lookup_maps_ready_submodules_by_path() {
        ...
        repo.submodules = Loadable::Ready(Arc::new(vec![
            repositorytree_core::domain::Submodule {
