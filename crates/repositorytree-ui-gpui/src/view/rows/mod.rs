...
#[inline]
fn commit_file_visuals(file: &repositorytree_core::domain::CommitFileChange) -> CommitFileKindVisuals {
...
mod tests {
    use super::*;
    use repositorytree_core::domain::{CommitFileChange, FileStatusKind};
