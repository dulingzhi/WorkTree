...
fn truncated_file_diff_display_len(raw_text: &repositorytree_core::file_diff::FileDiffLineText) -> usize {
...
mod tests {
    ...
    fn large_file_diff_display_is_bounded() {
        let raw_text = repositorytree_core::file_diff::FileDiffLineText::from(format!(
            "start\t{}",
