...
pub(super) trait RepositoryTreeTooltipExt: gpui::StatefulInteractiveElement + Sized {
    fn repositorytree_tooltip(self, theme: AppTheme, text: SharedString) -> Self {
...
impl<T: gpui::StatefulInteractiveElement> RepositoryTreeTooltipExt for T {}
                    ...
                    .update(cx, |this, cx| {
                        ...
                        let settings = session::UiSettings {
                            ...
                            history_tag_fetch_mode: Some(if history_auto_fetch_tags_on_repo_activation
                            {
                                ...
                                repositorytree_state::model::GitLogTagFetchMode::Disabled
                            }),
