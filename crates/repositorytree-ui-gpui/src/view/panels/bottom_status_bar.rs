...
impl BottomStatusBarView {
    pub(in super::super) fn new(theme: AppTheme, root_view: WeakEntity<RepositoryTreeView>) -> Self {
        Self {
            theme,
            root_view,
...
impl Render for BottomStatusBarView {
    fn render(&mut self, window: &mut Window, cx: &mut gpui::Context<Self>) -> impl IntoElement {
        ...
        let zoom_button = components::Button::new("bottom_status_bar_zoom", zoom_label)
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("chrome.status_bar.adjust_zoom"))
        ...
        let discord_badge = status_bar_chip("bottom_status_bar_discord", theme, ui_scale_percent)
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("chrome.status_bar.discord"));
        ...
        let free_badge = status_bar_chip("bottom_status_bar_free_badge", theme, ui_scale_percent)
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("chrome.status_bar.editions"))
        ...
        let brand = div()
            ...
            .child(
                div()
                    ...
                    .text_size(scaled_px(11.0))
                    .line_height(scaled_px(12.0))
                    .child("RepositoryTree"),
            )
            .on_click(cx.listener(|_this, _e: &ClickEvent, _window, cx| {
                cx.stop_propagation();
                cx.open_url(WEBSITE_URL);
            }))
            .repositorytree_tooltip(theme, crate::i18n::tr("chrome.status_bar.website"));
        ...
        let version_link = div()
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("chrome.status_bar.releases"))
            .child(version_label);
