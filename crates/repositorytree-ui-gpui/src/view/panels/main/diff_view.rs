...
use repositorytree_state::model::{InlineSubmoduleDiffEntry, InlineSubmoduleDiffSection};
use gpui::Focusable;
...
impl MainPaneView {
    ...
    pub(crate) fn handle_diff_shortcut(
        ...
        //   * RepositoryTree's Ctrl+Home/End resolver bindings are intentionally NOT
        ...
        // RepositoryTree resolver navigation: Ctrl+Home/End jump to the first/last
        ...
        let panel = div()
            ...
            .child(
                components::Button::new("diff_search_newline", "")
                    ...
                    .repositorytree_tooltip(theme, crate::i18n::tr("diff.search.insert_newline"))
            ...
            .child(
                components::Button::new("diff_search_match_case", "Aa")
                    ...
                    .h(compact_control_height)
                    .repositorytree_tooltip(theme, crate::i18n::tr("diff.search.match_case"))
            ...
            .child(
                components::Button::new("diff_search_whole_word", "W")
                    ...
                    .w(compact_option_button_width)
                    .h(compact_control_height)
                    .repositorytree_tooltip(theme, crate::i18n::tr("diff.search.match_whole_word"))
            ...
            .child(
                components::Button::new("diff_search_regex", ".*")
                    ...
                    .w(compact_option_button_width)
                    .h(compact_control_height)
                    .repositorytree_tooltip(theme, crate::i18n::tr("diff.search.use_regex"))
        ...
        if let Some(repo_id) = repo_id {
            ...
            controls = controls.child(
                components::Button::new(cog_id, "")
                    ...
                    .repositorytree_tooltip(theme, cog_tooltip.into()),
            );
            controls = controls.child(
                components::Button::new("diff_close", "")
                    ...
                    .repositorytree_tooltip(theme, crate::i18n::tr("diff.tooltip.close_diff")),
            );
        }
