...
impl MainPaneView {
    ...
    fn foreign_worktree_diff_chip(
        ...
        let repositorytree_state::model::ForeignDiffOrigin::Worktree { branch, detached } =
            &inline.origin
        else {
            return None;
        };
    ...
    pub(super) fn diff_viewer_nav_cluster(
        ...
        let badge = div()
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("tail.diff.show_file_history"));
        ...
        let back_btn = components::Button::new("viewer_nav_back", "")
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("tail.diff.back_previous_version"));
        ...
        let forward_btn = components::Button::new("viewer_nav_forward", "")
            ...
            .repositorytree_tooltip(theme, crate::i18n::tr("tail.diff.forward_next_version"));
    ...
    pub(super) fn diff_prev_next_file_buttons(
        ...
        let button = |id: &'static str,
            ...
            .repositorytree_tooltip(theme, SharedString::from(tooltip))
            .into_any_element()
        };
