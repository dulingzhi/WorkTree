...
fn assert_popover_open(view: &gpui::Entity<RepositoryTreeView>, app: &gpui::App, expected: bool) {
        ...
        view.update(app, |this, cx| {
            let mut repo = RepoState::new_opening(
                ...
                repositorytree_core::domain::RepoSpec {
                    workdir: std::env::temp_dir().join("repositorytree_ui_test_gitignore_dialog"),
                },
            );
...
fn gitignore_pattern_text(view: &gpui::Entity<RepositoryTreeView>, app: &gpui::App) -> String {
    view.read(app)
        .popover_host
        .read(app)
...
fn add_to_gitignore_prompt_scope_switch_rewrites_the_pattern(cx: &mut gpui::TestAppContext) {
    ...
    for (scope, expected) in [
        (repositorytree_core::gitignore::GitignoreScope::Folder, "/build/"),
        (repositorytree_core::gitignore::GitignoreScope::Extension, "*.log"),
        (
            repositorytree_core::gitignore::GitignoreScope::File,
            "/build/out.log",
        ),
    ] {
        cx.update(|_window, app| {
