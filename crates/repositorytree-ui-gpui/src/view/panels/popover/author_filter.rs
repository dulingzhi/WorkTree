...
fn collect_author_suggestions(commits: &[repositorytree_core::domain::Commit]) -> Vec<SharedString> {
...
mod tests {
    use super::*;
    use repositorytree_core::domain::{Commit, CommitId, CommitParentIds};
