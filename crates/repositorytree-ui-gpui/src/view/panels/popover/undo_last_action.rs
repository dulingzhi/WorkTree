use super::*;
use repositorytree_core::services::SequencerState;
use repositorytree_core::undo::{classify_undo, UndoAction, UndoPlan};
...
mod tests {
    use super::*;
    use repositorytree_core::domain::{CommitId, ReflogEntry};
    ...
    fn a_completed_operation_resolves_to_its_plan() {
        ...
        assert_eq!(plan.kind, repositorytree_core::undo::UndoKind::Merge);
