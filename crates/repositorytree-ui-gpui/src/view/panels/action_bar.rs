    ...
    fn render(&mut self, _window: &mut Window, cx: &mut gpui::Context<Self>) -> impl IntoElement {
        ...
        let sequencer_state = self
            ...
            .map(|repo| match repo.sequencer_state {
                ...
                _ if matches!(&repo.rebase_in_progress, Loadable::Ready(true)) => {
                    repositorytree_core::services::SequencerState::RebaseOrApply
                }
                _ => repositorytree_core::services::SequencerState::None,
            })
            .unwrap_or_default();
        let is_cherry_pick_in_progress =
            sequencer_state == repositorytree_core::services::SequencerState::CherryPick;
        let is_rebase_or_apply_in_progress =
            sequencer_state == repositorytree_core::services::SequencerState::RebaseOrApply;
        ...
        let terminal =
            components::Button::new("terminal", crate::i18n::tr("panels.action_bar.terminal"))
                ...
                .repositorytree_tooltip(theme, terminal_tooltip);
        let mut push_main =
        ...
        let create_branch =
            components::Button::new("create_branch", crate::i18n::tr("panels.action_bar.branch"))
                ...
                .repositorytree_tooltip(theme, crate::i18n::tr("panels.action_bar.create_branch"));
...
mod tests {
    ...
    use repositorytree_core::domain::Upstream;
