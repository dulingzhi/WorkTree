...
fn commit_details_author_row(
    ...
    details: &repositorytree_core::domain::CommitDetails,
    cx: &mut gpui::App,
) -> Option<Div> {
...
impl DetailsPaneView {
        ...
        let header = div()
            ...
            .child(
                components::Button::new("commit_details_close", "")
                    ...
                    .repositorytree_tooltip(theme, tr("layout.commit_details.close")),
            );
        ...
        let header = div()
            ...
            .child(
                components::Button::new("worktree_uncommitted_close", "")
                    ...
                    .repositorytree_tooltip(theme, tr("layout.worktree.close")),
            );
        ...
        let header = div()
            ...
            .child(
                components::Button::new("working_tree_review_close", "")
                    ...
                    .repositorytree_tooltip(theme, tr("layout.working_tree_review.close")),
            );
        ...
        let header = div()
            ...
            .child(
                components::Button::new("range_comparison_close", "")
                    ...
                    .repositorytree_tooltip(theme, tr("layout.comparison.close")),
            );
    ...
    pub(in super::super) fn commit_details_view(
        ...
        .repositorytree_tooltip(theme, tr("layout.status.stage_all_changes"));
        ...
        let untracked_paths_for_stage_all =
            repositorytree_state::msg::RepoPathList::from(untracked_paths.clone());
        ...
        .repositorytree_tooltip(theme, tr("layout.status.stage_all_untracked"));
        ...
        .repositorytree_tooltip(theme, tr("layout.status.stage_all_unstaged"));
        ...
        .repositorytree_tooltip(theme, tr("layout.status.unstage_all_changes"));
    ...
    pub(in super::super) fn commit_box(&mut self, cx: &mut gpui::Context<Self>) -> gpui::Div {
        ...
        let commit_main = components::Button::new("commit", commit_label)
            ...
            .repositorytree_tooltip(theme, commit_tooltip.into());
        let commit_menu = components::Button::new("commit_options", "")
            ...
            .repositorytree_tooltip(theme, tr("layout.commit_box.options"));
        let previous_messages_menu = components::Button::new("previous_commit_messages", "")
            ...
            .repositorytree_tooltip(theme, tr("layout.commit_box.previous_messages"));
...
mod tests {
    use super::*;
    use repositorytree_core::domain::{Branch, CommitId, LogPage, RepoSpec};
    use repositorytree_state::model::{Loadable, RepoId, RepoState};
