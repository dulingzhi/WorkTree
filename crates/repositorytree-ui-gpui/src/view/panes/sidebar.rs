            ...
            .when_some(section_menu.clone(), |header, (invoker, kind)| {
                header.child(
                    components::Button::new("collapsed_popover_section_menu", "")
                        ...
                        .w(scaled_px(22.0))
                        .h(scaled_px(22.0))
                        .repositorytree_tooltip(theme, crate::i18n::tr("chrome.sidebar.more_actions"))
                ...
                let element = {
                    ...
                    if is_directory {
                        ...
                        let source = repo
                            ...
                            .unwrap_or(repositorytree_core::domain::FileSource::WorkingDirectory);
                        row_div = row_div
                            .on_click(cx.listener(
                                move |_this, _e: &gpui::ClickEvent, _window, _cx| {
...
mod tests {
    ...
    fn sidebar_notify_fingerprint_tracks_live_workspace_badge_branch_changes() {
        ...
        active.worktrees = Loadable::Ready(Arc::new(vec![repositorytree_core::domain::Worktree {
    ...
    fn repo_with_local_and_remote_branches() -> RepoState {
        ...
        repo.branches = Loadable::Ready(Arc::new(vec![
            repositorytree_core::domain::Branch {
        ...
        repo.remote_branches = Loadable::Ready(Arc::new(vec![
            repositorytree_core::domain::RemoteBranch {
