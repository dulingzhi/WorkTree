...
use repositorytree_core::domain::ReflogEntry;
...
impl ReflogPaneView {
    ...
    fn render_reflog_row(
        ...
        div()
            ...
            .child({
                ...
                if is_current {
                    marker.repositorytree_tooltip(theme, "Current HEAD position".into())
                } else {
                    marker
                }
            })
            ...
            .child(
                div()
                    ...
                    .text_color(theme.colors.accent.foreground)
                    .child(short_sha)
                    .repositorytree_tooltip(theme, "View this commit in the history log".into()),
            )
            .child(
                div()
                    .w(px(22.0))
    ...
    fn render_header(
        ...
        let close = div()
            ...
            .repositorytree_tooltip(theme, "Close reflog".into())
            .on_mouse_down(
                MouseButton::Left,
                cx.listener(move |this, _e: &MouseDownEvent, _window, cx| {
                    cx.stop_propagation();
...
mod view_tests {
    use super::*;
    use repositorytree_state::model::RepoState;
    use std::cell::Cell;
    use std::rc::Rc;
    ...
    impl repositorytree_core::services::GitBackend for NoopBackend {
        fn open(
            &self,
            _workdir: &std::path::Path,
        ) -> std::result::Result<
            Arc<dyn repositorytree_core::services::GitRepository>,
            repositorytree_core::error::Error,
        > {
            Err(repositorytree_core::error::Error::new(
                repositorytree_core::error::ErrorKind::Unsupported("no repositories in this test"),
            ))
        }
    }
