...
use crate::view::rows;
use crate::view::{ConflictResolverUiState, RepositoryTreeViewMode};
use repositorytree_core::domain::{CommitId, DiffTarget, FileSource, RepoSpec};
use repositorytree_state::model::{ConflictFile, Loadable, RepoId, RepoState};
...
fn clear_diff_selection_action_is_clear_for_normal_mode() {
    assert_eq!(
        clear_diff_selection_action(RepositoryTreeViewMode::Normal),
...
fn clear_diff_selection_action_exits_focused_mergetool_mode() {
    assert_eq!(
        clear_diff_selection_action(RepositoryTreeViewMode::FocusedMergetool),
...
fn specialized_conflict_strategies_require_full_side_payloads() {
    use repositorytree_core::conflict_session::ConflictResolverStrategy;
...
fn focused_mergetool_marker_labels() -> repositorytree_core::conflict_output::ConflictMarkerLabels<'static>
{
    repositorytree_core::conflict_output::ConflictMarkerLabels {
        local: "LOCAL",
        remote: "REMOTE",
        base: "BASE",
    }
