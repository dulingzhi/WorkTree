...
impl MainPaneView {
    pub(in crate::view) fn file_diff_inline_word_ranges(
        ...
        if !matches!(
            ...
            repositorytree_core::domain::DiffLineKind::Add | repositorytree_core::domain::DiffLineKind::Remove
        ) {
        ...
        let ranges = self
            ...
            .map(|(old, new, kind)| {
                ...
                match kind {
                    repositorytree_core::domain::DiffLineKind::Remove => old_ranges,
                    repositorytree_core::domain::DiffLineKind::Add => new_ranges,
