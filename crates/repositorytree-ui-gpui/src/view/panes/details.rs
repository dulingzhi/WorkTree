...
use repositorytree_state::model::{AuthRetryOperation, CommandLogEntry};
...
pub(in super::super) struct DetailsPaneView {
    ...
    pub(in super::super) ai_commit_test_last_context:
        Option<Arc<repositorytree_state::model::AiCommitContext>>,
...
pub(in super::super) struct DetailsPaneInit {
    ...
    pub(in super::super) timezone: crate::view::date_time::Timezone,
    pub(in super::super) show_timezone: bool,
    pub(in super::super) root_view: WeakEntity<RepositoryTreeView>,
    pub(in crate::view) tooltip_host: WeakEntity<TooltipHost>,
}
...
impl DetailsPaneView {
    ...
    fn spawn_ai_commit_generation(
        &mut self,
        repo_id: RepoId,
        context: Arc<repositorytree_state::model::AiCommitContext>,
        cx: &mut gpui::Context<Self>,
    ) {
    ...
    pub(in super::super) fn selected_worktree_summary(
        &self,
    ) -> Option<&repositorytree_core::domain::WorktreeDirtySummary> {
    ...
    pub(in super::super) fn cached_worktree_file_inputs(
        ...
        summary: &repositorytree_core::domain::WorktreeDirtySummary,
    ) -> Arc<WorktreeFileListInputs> {
        ...
        let entries = repositorytree_state::model::worktree_inline_diff_entries(summary);
        let files = entries
            .iter()
            .map(|entry| repositorytree_core::domain::CommitFileChange {
...
mod tests {
    use super::*;
    use repositorytree_state::model::{AuthPromptState, PendingCommitRetry};
