...
pub(in crate::view) fn show_titlebar_secondary_menu<T: 'static>(
    ...
    if let Some(request) = crate::app::window_system_menu_request(window, position) {
        ...
        cx.spawn(async move |_this, _cx: &mut gpui::AsyncApp| {
            repositorytree_win32_window_utils::show_window_system_menu(
                request.hwnd,
                request.x,
                request.y,
            );
...
impl Render for TitleBarView {
    fn render(&mut self, window: &mut Window, cx: &mut gpui::Context<Self>) -> impl IntoElement {
        ...
        let menu_toggle = div()
            ...
            .child(
                components::Button::new("app_menu_btn", "")
                    ...
                    .repositorytree_tooltip(theme, crate::i18n::tr("app.chrome.application_menu")),
            );
        ...
        let repo_picker_toggle = div()
            ...
            .child(
                div()
                    ...
                    .repositorytree_tooltip(theme, crate::i18n::tr("app.chrome.switch_repository")),
            );
        ...
        .repositorytree_tooltip(theme, min_tooltip)
        ...
        .repositorytree_tooltip(theme, max_tooltip)
        .on_click(cx.listener(|_this, _e: &ClickEvent, window, cx| {
            cx.stop_propagation();
        ...
        .repositorytree_tooltip(theme, close_tooltip)
        .on_click(cx.listener(|_this, _e: &ClickEvent, window, cx| {
            cx.stop_propagation();
