...
impl RepositoryTreeView {
    ...
    pub(crate) fn blocks_non_repository_actions(&self) -> bool {
        repository_entry_interstitial_active(self.view_mode, self.has_repo_tabs())
            || matches!(self.view_mode, RepositoryTreeViewMode::Normal) && self.git_runtime_unavailable()
    }
    ...
    fn interstitial_logo(_theme: AppTheme, size: Pixels) -> AnyElement {
        div()
            ...
            .size(size)
            .child(gpui::svg().path("repositorytree_logo.svg").w(size).h(size))
            .into_any_element()
    }
    ...
    fn git_unavailable_open_settings_button(
        ...
        .repositorytree_tooltip(self.theme, settings_tooltip)
    ...
    pub(super) fn splash_screen(&mut self, cx: &mut gpui::Context<Self>) -> AnyElement {
        ...
        .repositorytree_tooltip(self.theme, open_tooltip)
        ...
        let clone_button = {
            ...
            .repositorytree_tooltip(self.theme, clone_tooltip)
    ...
    fn collapsed_sidebar_rail(
        ...
        let icons = CollapsedSidebarSection::ALL.into_iter().map(|section| {
            ...
            div()
                ...
                .repositorytree_tooltip(theme, section.title().into())
        });
