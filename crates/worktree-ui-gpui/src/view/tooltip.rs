...
pub(super) trait WorkTreeTooltipExt: gpui::StatefulInteractiveElement + Sized {
    fn worktree_tooltip(self, theme: AppTheme, text: SharedString) -> Self {
...
impl<T: gpui::StatefulInteractiveElement> WorkTreeTooltipExt for T {}
                    ...
                    .update(cx, |this, cx| {
                        ...
                        let settings = session::UiSettings {
                            ...
                            history_tag_fetch_mode: Some(if history_auto_fetch_tags_on_repo_activation
                            {
                                ...
                                worktree_state::model::GitLogTagFetchMode::Disabled
                            }),
