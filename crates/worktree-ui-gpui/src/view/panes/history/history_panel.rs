...
impl HistoryView {
    pub(super) fn dismiss_history_refs_hover(&self, cx: &mut gpui::Context<Self>) {
        ...
        // History reveal completion can run while WorkTreeView is already inside a root update.
        ...
        let scope_label: SharedString = self
            ...
            .unwrap_or_else(|| {
                crate::view::history_mode::history_mode_label(
                    worktree_core::domain::HistoryMode::default(),
                )
                .to_string()
            })
            .into();
                        ...
                        div()
                            ...
                            .child(
                                div()
                                    ...
                                    .worktree_tooltip(theme, ref_filter_tooltip),
                            ),
                    ),
            )
                            ...
                            div()
                                ...
                                .child(
                                    div()
                                        ...
                                        .worktree_tooltip(theme, author_tooltip),
                                ),
                        ),
                )
            });
