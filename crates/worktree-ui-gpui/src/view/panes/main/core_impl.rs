...
use super::helpers::{
    ...
    ICommitEditorMode, IRebaseViewState, apply_focused_mergetool_output,
...
impl MainPaneView {
    ...
    pub(in crate::view) fn new(
        ...
        let (conflict_resolver_input, conflict_resolver_subscription) =
            resolved_output_syntax::new_conflict_resolver_input(window, cx);
