...
use super::super::helpers::{
    ...
    build_resolved_output_conflict_markers_from_block_ranges, coalesce_resolved_output_edit_deltas,
    conflict_marker_ranges_for_block, count_newlines, dirty_byte_range_to_line_range,
    indexed_line_count, remap_resolved_output_conflict_block_ranges_for_delta,
    ...
    resolved_output_snapshot_is_modified, resolved_output_unresolved_rows,
    resolved_output_unresolved_spans_for_active, shifted_line_index,
    should_skip_resolved_outline_provenance, write_conflict_markers_for_ranges,
};
use super::*;
...
pub(super) fn new_conflict_resolver_input(
    window: &mut Window,
