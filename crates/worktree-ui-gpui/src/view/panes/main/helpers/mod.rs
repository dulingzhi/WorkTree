...
//! The surface is the old file's full `pub(in crate::view)` set verbatim; not
//! every name has a consumer in every build configuration, hence the allow.
...
pub(in crate::view) use conflict_blocks::{
    CachedUnresolvedRows, ResolvedOutputKey, UnresolvedDecisionRegion, UnresolvedRows,
    append_choice_after_conflict_block, apply_conflict_choice_provenance_hints,
    ...
    build_resolved_output_conflict_markers_from_ranges, conflict_block_matches_group,
    ...
    push_conflict_text_segment, remove_conflict_block_at, reset_conflict_block_selection,
    ...
    should_remove_conflict_block_on_reset, split_target_conflict_block_into_subchunks,
    unresolved_decision_ranges_for_block, unresolved_decision_regions_for_block,
    unresolved_subchunk_conflict_ranges_for_block, write_conflict_markers_for_ranges,
};
#[cfg(test)]
#[allow(unused_imports)]
pub(in crate::view) use conflict_blocks::{
...
pub(in crate::view) use diff_metrics::{
    ...
    historical_browse_content, parse_conflict_canvas_rows_env,
...
pub(in crate::view) use focused_mergetool::{
    ClearDiffSelectionAction, FocusedMergetoolOutput, FocusedMergetoolSavePayload,
    apply_focused_mergetool_output, build_focused_mergetool_save_payload,
    clear_diff_selection_action, conflict_strategy_needs_full_side_payloads,
    focused_mergetool_save_exit_code,
};

#[cfg(test)]
#[allow(unused_imports)]
pub(in crate::view) use resolved_output_text::preview_source_text_from_lines;
#[allow(unused_imports)]
pub(in crate::view) use resolved_output_text::{
    LARGE_RESOLVED_OUTLINE_THREE_WAY_PROVENANCE_MAX_LINES,
    LARGE_RESOLVED_OUTLINE_TWO_WAY_PROVENANCE_MAX_LINES, ResolvedOutlineDelta,
    ResolvedOutputSourceRevision, ResolvedOutputUnresolvedSpans, StashedResolvedOutlineState,
    append_line_insertion_text, apply_resolved_output_unresolved_highlights, build_line_starts,
    build_line_starts_with_count, coalesce_resolved_output_edit_deltas,
    ...
    line_content_byte_range_for_index, line_index_for_offset, line_start_offset_for_index,
    preview_line_flags_for_text, preview_line_flags_from_bools, preview_line_flags_from_source,
    ...
    resolved_output_unresolved_highlight_style, shifted_line_index,
...
pub(in crate::view) use scroll_reveal::{
    DIFF_SEARCH_HORIZONTAL_REVEAL_ATTEMPTS, RESOLVED_OUTPUT_ROW_HEIGHT_PX, SEARCH_REVEAL_MARGIN_PX,
