...
use self::geometry::{
    ...
    paint_gutter_text, paint_gutter_text_right_aligned, row_bg_fill_bounds,
    single_column_text_bounds, split_columns,
};
...
pub(super) struct StreamedDiffTextPaintSpec {
    pub(super) raw_text: worktree_core::file_diff::FileDiffLineText,
