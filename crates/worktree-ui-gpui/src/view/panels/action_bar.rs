    ...
    fn render(&mut self, _window: &mut Window, cx: &mut gpui::Context<Self>) -> impl IntoElement {
        ...
        let sequencer_state = self
            ...
            .map(|repo| match repo.sequencer_state {
                ...
                _ if matches!(&repo.rebase_in_progress, Loadable::Ready(true)) => {
                    worktree_core::services::SequencerState::RebaseOrApply
                }
                _ => worktree_core::services::SequencerState::None,
            })
            .unwrap_or_default();
        let is_cherry_pick_in_progress =
            sequencer_state == worktree_core::services::SequencerState::CherryPick;
        let is_rebase_or_apply_in_progress =
            sequencer_state == worktree_core::services::SequencerState::RebaseOrApply;
        ...
        let terminal =
            components::Button::new("terminal", crate::i18n::tr("panels.action_bar.terminal"))
                ...
                .worktree_tooltip(theme, terminal_tooltip);
        let mut push_main =
        ...
        let create_branch =
            components::Button::new("create_branch", crate::i18n::tr("panels.action_bar.branch"))
                ...
                .worktree_tooltip(theme, crate::i18n::tr("panels.action_bar.create_branch"));
                        ...
                        div()
                            ...
                            .child(
                                div().debug_selector(|| "bisect_bad_button".to_string()).child(
                                    ...
                                    .worktree_tooltip(theme, mark_tooltip.clone()),
                                ),
                            )
                            .child(
                                div().debug_selector(|| "bisect_good_button".to_string()).child(
                                    ...
                                    .worktree_tooltip(theme, mark_tooltip),
                                ),
                            )
                            .child(
                                div().debug_selector(|| "bisect_skip_button".to_string()).child(
                                    ...
                                    .on_click(theme, cx, |this, _e, _w, _cx| {
                                        if let Some(repo_id) = this.active_repo_id() {
                                            this.store.dispatch(Msg::BisectMark {
                                                repo_id,
                                                verdict: worktree_core::services::BisectVerdict::Skip,
                                                commit: None,
                                            });
                                        }
                                    }),
                            ...
                            .child(
                                div().debug_selector(|| "bisect_reset_button".to_string()).child(
                                    ...
                                    .worktree_tooltip(theme, reset_tooltip),
                                ),
                            ),
                    )
                }),
