...
#[cfg(test)]
const SETTINGS_WINDOW_TITLE: &str = "Settings: WorkTree";
const SETTINGS_TRAFFIC_LIGHTS_SAFE_INSET_PX: f32 = 78.0;
const MIN_GIT_MAJOR: u32 = 2;
const MIN_GIT_MINOR: u32 = 50;
const GITHUB_URL: &str = "https://github.com/dulingzhi/WorkTree";
const THEMES_GUIDE_URL: &str = "https://github.com/dulingzhi/WorkTree/blob/main/docs/themes.md";
const LICENSE_URL: &str = "https://github.com/dulingzhi/WorkTree/blob/main/LICENSE-AGPL-3.0";
