...
pub(super) struct ConflictResolverUiState {
    ...
    pub(super) path: Option<std::path::PathBuf>,
    pub(super) shared_path: Option<worktree_state::msg::RepoPath>,
    pub(super) loaded_file: Option<worktree_state::model::ConflictFile>,
    ...
    pub(super) minimap_bands: Arc<[worktree_core::merge::MinimapRowKind]>,
    ...
    pub(super) strategy: Option<worktree_core::conflict_session::ConflictResolverStrategy>,
...
impl ConflictResolverUiState {
    ...
    pub(super) fn dispatch_path(&self) -> Option<worktree_state::msg::RepoPath> {
...
pub(super) struct ConflictResolverJoinTarget {
    ...
    pub(super) path: worktree_state::msg::RepoPath,
    pub(super) conflict_rev: u64,
