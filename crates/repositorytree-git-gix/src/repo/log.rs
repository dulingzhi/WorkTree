...
impl GixRepo {
    ...
    /// avatars. See
    /// [`repositorytree_core::services::GitRepository::author_email_map`] for the
    ...
    /// [`repositorytree_core::services::GitRepository::log_history_mode_page_streaming`].
...
mod tests {
    ...
    fn diff_range_files_accepts_the_empty_tree_as_a_base() {
        use repositorytree_core::domain::{EMPTY_TREE_ID, FileStatusKind};
        use repositorytree_core::services::GitRepository;
