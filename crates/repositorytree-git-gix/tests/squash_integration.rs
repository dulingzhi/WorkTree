...
use repositorytree_core::services::{GitBackend, GitRepository, InteractiveRebaseAction};
...
/// simulating an interactive rebase planned outside RepositoryTree.
#[cfg(unix)]
...
fn rebase_continue_rejects_damaged_persisted_reword_state() {
    ...
    let persisted = git_path(&repo, "rebase-merge/repositorytree-reword");
