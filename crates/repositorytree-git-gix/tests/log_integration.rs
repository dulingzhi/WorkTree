use repositorytree_core::domain::{CommitId, FileStatusKind, HistoryMode, LogCursor};
use repositorytree_core::error::{ErrorKind, GitFailureId};
...
fn commit_details_reports_root_and_rename_file_changes() {
    ...
    assert_eq!(
        root_details.files,
        vec![repositorytree_core::domain::CommitFileChange {
