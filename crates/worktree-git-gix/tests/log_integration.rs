use worktree_core::domain::{CommitId, FileStatusKind, HistoryMode, LogCursor};
...
/// filter.
fn refs_page(
    opened: &dyn worktree_core::services::GitRepository,
    mode: HistoryMode,
    refs: &[&str],
...
fn commit_details_reports_root_and_rename_file_changes() {
    ...
    assert_eq!(
        root_details.files,
        vec![worktree_core::domain::CommitFileChange {
