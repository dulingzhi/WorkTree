...
pub const REPOSITORYTREE_AUTH_KIND_ENV: &str = "REPOSITORYTREE_AUTH_KIND";
pub const REPOSITORYTREE_AUTH_USERNAME_ENV: &str = "REPOSITORYTREE_AUTH_USERNAME";
pub const REPOSITORYTREE_AUTH_SECRET_ENV: &str = "REPOSITORYTREE_AUTH_SECRET";
pub const REPOSITORYTREE_AUTH_CACHE_SIZE_ENV: &str = "REPOSITORYTREE_AUTH_CACHE_SIZE";
pub const REPOSITORYTREE_AUTH_CACHE_PROMPT_ENV_PREFIX: &str = "REPOSITORYTREE_AUTH_CACHE_PROMPT_";
pub const REPOSITORYTREE_AUTH_CACHE_SECRET_ENV_PREFIX: &str = "REPOSITORYTREE_AUTH_CACHE_SECRET_";

pub const REPOSITORYTREE_AUTH_KIND_USERNAME_PASSWORD: &str = "username_password";
pub const REPOSITORYTREE_AUTH_KIND_PASSPHRASE: &str = "passphrase";
pub const REPOSITORYTREE_AUTH_KIND_PASSPHRASE_CACHED: &str = "passphrase_cached";
pub const REPOSITORYTREE_AUTH_KIND_HOST_VERIFICATION: &str = "host_verification";
