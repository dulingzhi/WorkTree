...
pub struct ConflictRegionResolutionUpdate {
    ...
    pub resolution: repositorytree_core::conflict_session::ConflictRegionResolution,
}
...
pub enum Msg {
    ...
    ConflictToggleRegionSource {
        ...
        path: RepoPath,
        region_index: usize,
        source: repositorytree_core::merge::MergeSource,
    },
    ...
    ConflictSplitRegion {
        ...
        path: RepoPath,
        region_index: usize,
        boundaries: repositorytree_core::conflict_session::ConflictRegionSplitBoundaries,
    ...
    ConflictAddManualAlignment {
        repo_id: RepoId,
        path: RepoPath,
        alignment: repositorytree_core::merge::ManualAlignment,
...
pub enum InternalMsg {
    ...
    AuthorEmailsLoaded {
        repo_id: RepoId,
        result: Result<FxHashMap<String, String>, Error>,
    },
    BlameLoaded {
        repo_id: RepoId,
        path: PathBuf,
        source: repositorytree_core::domain::BlameSource,
        result: Result<Vec<repositorytree_core::services::BlameLine>, Error>,
    },
    ConflictFileLoaded {
        repo_id: RepoId,
        path: PathBuf,
