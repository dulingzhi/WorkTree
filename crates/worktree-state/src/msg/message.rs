...
pub struct ConflictRegionResolutionUpdate {
    ...
    pub resolution: worktree_core::conflict_session::ConflictRegionResolution,
}
...
pub enum Msg {
    ...
    SetCoverage {
        repo_id: RepoId,
        report: Arc<worktree_core::coverage::CoverageReport>,
    },
    ClearCoverage {
        repo_id: RepoId,
    },
    ...
    ConflictToggleRegionSource {
        ...
        path: RepoPath,
        region_index: usize,
        source: worktree_core::merge::MergeSource,
    },
    ...
    ConflictSplitRegion {
        ...
        path: RepoPath,
        region_index: usize,
        boundaries: worktree_core::conflict_session::ConflictRegionSplitBoundaries,
    ...
    ConflictAddManualAlignment {
        repo_id: RepoId,
        path: RepoPath,
        alignment: worktree_core::merge::ManualAlignment,
...
pub enum InternalMsg {
    ...
    BlameLoaded {
        ...
        path: PathBuf,
        source: worktree_core::domain::BlameSource,
        result: Result<Vec<worktree_core::services::BlameLine>, Error>,
    },
    ConflictFileLoaded {
        repo_id: RepoId,
        path: PathBuf,
