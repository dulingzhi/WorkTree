...
fn push_merge_request_emits_effect_marks_in_flight_and_summarizes() {
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::RepoCommandFinished {
            ...
            result: Ok(worktree_core::services::CommandOutput {
...
fn reset_emits_effect() {
    ...
    let effects = reduce(
        ...
        Msg::Reset {
            ...
            mode: worktree_core::services::ResetMode::Hard,
        },
    );

    assert!(matches!(
        effects.as_slice(),
        [Effect::Reset { repo_id: RepoId(1), target, mode: worktree_core::services::ResetMode::Hard }]
            if target == "HEAD~1"
    ));
}
...
fn selected_submodule_command_reloads_selected_summary() {
    ...
    ) -> (AppState, worktree_core::domain::DiffTarget) {
        let mut state = AppState::default();
...
fn ready_working_tree_blame() -> Loadable<std::sync::Arc<Vec<worktree_core::services::BlameLine>>> {
...
fn commit_finished_invalidates_loaded_blame() {
    ...
    state.repos[0].history_state.blame_path = Some(PathBuf::from("src/lib.rs"));
    state.repos[0].history_state.blame_source = Some(
        worktree_core::domain::BlameSource::WorkingTree(DiffArea::Staged),
    );
    state.repos[0].history_state.blame = ready_working_tree_blame();
...
fn additional_routing_messages_emit_effects_and_update_counters() {
    ...
    let effects = reduce(
        ...
        Msg::SetRemoteUrl {
            ...
            kind: worktree_core::services::RemoteUrlKind::Push,
        },
    );
    assert!(matches!(
        effects.as_slice(),
...
fn pull_request_list_load_messages_drive_the_loadable() {
    ...
    assert_eq!(
        ...
        Loadable::<Arc<Vec<worktree_core::domain::PullRequest>>>::Loading
    );
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::PullRequestsLoaded {
            repo_id: RepoId(1),
            result: Ok(vec![worktree_core::domain::PullRequest {
                number: 7,
                title: "Fix".into(),
                author: "alice".into(),
                head_ref: "fix".into(),
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::PullRequestChecksLoaded {
            repo_id: RepoId(1),
            number: 7,
            checks: worktree_core::domain::PullRequestChecksState::Success,
        }),
    );
    assert!(matches!(
        &state.repos[0].pull_requests,
        Loadable::Ready(list) if list[0].checks
            == Some(worktree_core::domain::PullRequestChecksState::Success)
    ));
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::PullRequestsLoaded {
            ...
            result: Err(worktree_core::error::Error::new(
                worktree_core::error::ErrorKind::Backend("offline".into()),
            )),
        }),
    );
    assert_eq!(
        state.repos[0].pull_requests,
        Loadable::<Arc<Vec<worktree_core::domain::PullRequest>>>::Error("offline".into())
    );
}
...
fn local_submodule_add_trust_prompt_confirms_into_add_effect() {
    ...
    let source = worktree_core::services::SubmoduleTrustTarget {
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::SubmoduleAddTrustChecked {
            ...
            name: None,
            force: false,
            result: Ok(worktree_core::services::SubmoduleTrustDecision::Prompt {
...
fn submodule_trust_check_pending_marks_and_clears_around_the_check() {
    ...
    let _ = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::SubmoduleAddTrustChecked {
            ...
            force: false,
            result: Ok(worktree_core::services::SubmoduleTrustDecision::Prompt {
                sources: vec![worktree_core::services::SubmoduleTrustTarget {
                    submodule_path: PathBuf::from("mods/sub"),
                    display_source: "../local-sub".to_string(),
                    local_source_path: PathBuf::from("/tmp/local-sub"),
                }],
...
fn submodule_add_progress_starts_when_trust_check_proceeds() {
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::SubmoduleAddTrustChecked {
            ...
            force: true,
            result: Ok(worktree_core::services::SubmoduleTrustDecision::Proceed),
        }),
    );
...
fn submodule_add_progress_clears_on_failed_add_command() {
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::RepoCommandFinished {
            ...
            result: Err(worktree_core::error::Error::new(
                worktree_core::error::ErrorKind::Backend("submodule add failed".to_string()),
            )),
        }),
    );
...
fn commit_finished_push_after_commit_enqueues_safe_push_only_on_success() {
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::CommitFinished {
            repo_id,
            result: Ok(worktree_core::services::CommitOperationOutcome {
...
fn safe_push_after_commit_decision_push_enqueues_checked_push() {
    ...
    let mut state = AppState::default();
    let repo_id = RepoId(1);
    let target = worktree_core::services::SafePushAfterCommitTarget {
        remote: "origin".to_string(),
        branch: "main".to_string(),
        local_branch: "main".to_string(),
        local_head: CommitId("2222222222222222222222222222222222222222".into()),
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::SafePushAfterCommitFinished {
            ...
            result: Ok(worktree_core::services::SafePushAfterCommitDecision::Push {
                target: target.clone(),
            }),
        }),
    );
...
fn safe_push_after_commit_decision_push_set_upstream_enqueues_checked_push() {
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::SafePushAfterCommitFinished {
            ...
            auth: None,
            result: Ok(
                worktree_core::services::SafePushAfterCommitDecision::PushSetUpstream {
                    target: target.clone(),
                },
            ),
        }),
...
fn safe_push_after_commit_published_amend_block_stores_lease_offer() {
    ...
    let lease = worktree_core::services::ForcePushLease {
        remote: "origin".to_string(),
        branch: "main".to_string(),
    ...
    let effects = reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::SafePushAfterCommitFinished {
            ...
            auth: None,
            result: Ok(
                worktree_core::services::SafePushAfterCommitDecision::Blocked {
        ...
        Msg::Internal(crate::msg::InternalMsg::RepoCommandFinished {
            ...
            command: RepoCommandKind::InteractiveCherryPick {
                entries: vec![worktree_core::services::InteractiveRebaseEntry {
                    action: worktree_core::services::InteractiveRebaseAction::Pick,
...
fn hunk_staging_is_logged_without_announcing_success() {
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::RepoCommandFinished {
            ...
            command: RepoCommandKind::StageHunk,
            result: Err(worktree_core::error::Error::new(
                worktree_core::error::ErrorKind::Backend("patch does not apply".into()),
            )),
        }),
    );
    let repo_state = state.repos.iter().find(|r| r.id == repo_id).unwrap();
...
fn repo_state_with_tags_loaded(repo_id: RepoId) -> RepoState {
    ...
    repo_state.local_actions_in_flight = 1;
    repo_state.set_tags(Loadable::Ready(vec![worktree_core::domain::Tag {
        name: "v1.0.0".to_string(),
...
fn create_tag_failed_does_not_reload_tags() {
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::RepoCommandFinished {
            ...
            result: Err(worktree_core::error::Error::new(
                worktree_core::error::ErrorKind::Backend("tag already exists".to_string()),
            )),
        }),
    );
...
fn cherry_pick_setup_applies_repository_topological_order() {
    ...
    let entry = |commit_id: &str, summary: &str| worktree_core::services::InteractiveRebaseEntry {
        action: worktree_core::services::InteractiveRebaseAction::Pick,
...
fn cherry_pick_setup_never_enables_rewording_after_partial_or_stale_message_load() {
    ...
    let entry = |commit_id: &str| worktree_core::services::InteractiveRebaseEntry {
        action: worktree_core::services::InteractiveRebaseAction::Pick,
        commit_id: commit_id.to_string(),
        summary: "subject".to_string(),
        message: "subject".to_string(),
...
fn ai_commit_context_load_error_is_recorded_not_swallowed() {
    ...
    reduce(
        ...
        Msg::Internal(crate::msg::InternalMsg::AiCommitContextLoaded {
            ...
            request_rev,
            result: Err(worktree_core::error::Error::new(
                worktree_core::error::ErrorKind::Backend("diff failed".to_string()),
            )),
        }),
    );
    assert!(matches!(
...
fn behind_remote_push_error() -> Error {
    Error::new(ErrorKind::Git(worktree_core::error::GitFailure::new(
        "git push",
        worktree_core::error::GitFailureId::CommandFailed,
        Some(1),
        Vec::new(),
...
fn coverage_set_and_clear_store_the_report_without_effects() {
    ...
    let report = std::sync::Arc::new(
        worktree_core::coverage::CoverageReport::parse_lcov(
            "SF:src/lib.rs\nDA:1,2\nDA:2,0\nend_of_record\n",
        )
        .unwrap(),
    );
