use super::{ReduceOutcome, begin_local_action, conflict_interactions, util};
use crate::model::{AppState, RepoId};
use crate::msg::{
    ConflictAutosolveMode, ConflictAutosolveStats, ConflictBulkChoice, ConflictBulkScope,
    ConflictRegionChoice, ConflictRegionResolutionUpdate, Effect, Msg, RepoPath,
};
...
pub(super) fn reduce_conflict_interactions(msg: Msg, state: &mut AppState) -> ReduceOutcome {
