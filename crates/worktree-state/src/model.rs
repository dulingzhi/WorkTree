...
pub struct RepoState {
    ...
    pub author_emails: FxHashMap<String, String>,
    ...
    /// persist.
    pub coverage: Option<Arc<worktree_core::coverage::CoverageReport>>,
...
impl RepoState {
    ...
    pub(crate) fn set_coverage(
        &mut self,
        coverage: Option<Arc<worktree_core::coverage::CoverageReport>>,
    ) {
