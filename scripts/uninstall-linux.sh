...
rm -f "${bindir}/worktree"
rm -f "${appdir}/worktree.desktop"
for size in "${icon_sizes[@]}"; do
  rm -f "${iconsroot}/${size}x${size}/apps/worktree.png"
done
...
echo "Uninstalled WorkTree desktop integration from ${prefix} and ~/.local/share."
